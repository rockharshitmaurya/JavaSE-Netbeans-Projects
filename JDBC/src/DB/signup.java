...
public class signup extends javax.swing.JFrame {
    ...
    try
    {
      ...
      String repass=t4.getText();
      db.pstmt=db.con.prepareStatement("insert into login_page (user,password,utype,contact) values(?,?,?,?)");
      ...
      if(i>0)
      {
          JOptionPane.showMessageDialog(this,"SignUp Sussesfully");
      }
    }
    catch(Exception e)
    {
